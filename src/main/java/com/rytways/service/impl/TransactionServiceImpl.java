...
//		private String pathToPDF;
	...
	//	public String exportReport(int poId) throws FileNotFoundException, JRException {
...
//		}
	    ...
	    @SuppressWarnings("deprecation")
		public StreamingResponseBody exportReleaseReport(ReleaseTrackItems release) throws FileNotFoundException, JRException {
...
//	    	
	        ...
	        IssueSolution solution = issueSolutionRepo.findByIssueTypeAndFunctionActivityId(release.getIssueType(), release.getActivityId());
...
//	        activityData.add(row3);
			...
			jasperReport = JasperCompileManager.compileReport(getClass().
					getResourceAsStream("/reports/releasereport.jrxml"));
...
//		            parameters.put("imageLocation", getClass().getResource("/images/Sripathi.jpg").getPath());
	    ...
	    public StreamingResponseBody exportReleaseReportForAllActivities(ReleaseTrack releaseTrack) throws FileNotFoundException, JRException {
...
//	        JasperReport jasperReport = JasperCompileManager.compileReport(getClass().getResourceAsStream("/reports/releasereport.jrxml"));
	        ...
	        for (ReleaseTrackItems item : items) {
	            ...
	            JasperReport jasperReport = isFirst
	                    ...
	                    : JasperCompileManager.compileReport(getClass().getResourceAsStream("/reports/releasesubreport.jrxml"));

	            List<ActivityMaster> activityData = Collections.singletonList(act);

	            IssueSolution solution = issueSolutionRepo.findByIssueTypeAndFunctionActivityId("Activity", item.getActivityId());
	            List<IssueSolutionComments> commentList = (solution != null) ?
	                    issueSolutionCommmentsRepo.findByIssueId(solution.getIssueId()) : new ArrayList<>();
...
//			            parameters.put("imageLocation", getClass().getResource("/images/Sripathi.jpg").getPath());
	            ...
	            parameters.put("currentProblem", solution != null && solution.getCurrentProblem() != null ? solution.getCurrentProblem() : "N/A");
	            parameters.put("solution", solution != null && solution.getSolution() != null ? solution.getSolution() : "N/A");
	            parameters.put("dataPoints", solution != null && solution.getDataPoints() != null ? solution.getDataPoints() : "N/A");
	            parameters.put("controls", solution != null && solution.getControls() != null ? solution.getControls() : "N/A");
